...
def campaign(profile, engine, scenario, block, order, experiment_id):
    bindings = {
...
def main():
    ...
    for block in range(args.blocks):
        ...
        for order, (profile, engine, scenario) in enumerate(block_cells):
            ...
            config.write_text(campaign(profile, engine, scenario, block, order, args.experiment_id))
